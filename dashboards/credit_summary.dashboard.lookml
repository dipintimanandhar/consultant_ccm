- dashboard: credit_analysis_suggested
  title: Credit Analysis (Suggested)
  layout: newspaper
  ...
  - title: Credit Name
    ...
    dynamic_fields: [{category: dimension, description: '', label: Credit Type Field,
        ...
        dimension: credit_type_field, args: [gcp_billing_export__credits.type, [!ruby/hash:ActiveSupport::HashWithIndifferentAccess {
              label: Credit Type Group, filter: '', __FILE: looker_ccm/dashboards/updated_dashboards/credit_analysis.dashboard.lookml,
              __LINE_NUM: 789}], !!null ''], _kind_hint: dimension, _type_hint: string}]
    show_view_names: false
    show_row_numbers: true
    transpose: false
    truncate_text: true
